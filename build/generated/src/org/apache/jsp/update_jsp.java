...
Consultas q = new Consultas(); 
 ...
 ResultSet rs = q.getalldates();
      out.write("\n");
      out.write("        \n");
      out.write("        <form action=\"FormularioUpdate\" method=\"post\">\n");
      out.write("        \n");
      out.write("            <select name=\"usuarios\" id=\"usuarios\">\n");
      out.write("                ");
 while(rs.next()) { 
      out.write("\n");
      out.write("\n");
      out.write("                <option name=\"usuario\" id=\"usuario\" onclick=\"automatic()\" value=");
